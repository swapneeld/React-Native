...
type Props = {};
class ESApp extends Component<Props> {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>
          Enterprise Services Mobile Application
        </Text>
        ...
        <TouchableOpacity onPress={this.updateFnApp}>
          <Text>Change to Finance Mobile Experience</Text>
        </TouchableOpacity>
      </View>
    );
  }
...
ESApp = codePush(codePushOptions)(ESApp);
